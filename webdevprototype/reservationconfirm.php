...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE users SET program = '$program' ,start_date = '$start_date', end_date = '$end_date',before_weightkg = '$before_weightkg',before_heightkg = '$before_heightkg'  where username = '$unamestring'";
