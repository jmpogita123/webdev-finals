    ...
    if(isset($_POST['remove_reservation'])){
        ...
        $sql = "UPDATE users SET program = '$program' ,start_date = '$start_date', end_date = '$end_date', instructor = '$instructor',before_weightkg = '$before_weightkg', before_heightkg = '$before_heightkg' where username = '$unamestring'";
